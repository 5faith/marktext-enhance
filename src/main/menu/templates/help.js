    ...
    submenu: [
      {
        ...
        click() {
          shell.openExternal(
            "https://github.com/5faith/marktext-enhance/blob/master/docs/README.md",
          );
        },
      },
      {
        ...
        click() {
          shell.openExternal(
            "https://github.com/5faith/marktext-enhance/blob/master/docs/MARKDOWN_SYNTAX.md",
          );
        },
      },
      {
        ...
        click() {
          shell.openExternal(
            "https://github.com/5faith/marktext-enhance/blob/master/.github/CHANGELOG.md",
          );
        },
      },
      {
      ...
      },
      {
        ...
        click() {
          shell.openExternal(
            "https://github.com/5faith/marktext-enhance/issues",
          );
        },
      },
      {
      ...
      },
      {
        ...
        click() {
          shell.openExternal("https://github.com/5faith/marktext-enhance");
        },
      },
      {
      ...
      },
      {
        ...
        click() {
          shell.openExternal(
            "https://github.com/5faith/marktext-enhance/blob/master/LICENSE",
          );
        },
      },
    ],
