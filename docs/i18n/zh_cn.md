...
您可以从 [release 页面](https://github.com/5faith/marktext-enhance/releases/latest)下载最新的 `marktext-%version%.dmg` 或者使用 [**homebrew cask**](https://github.com/caskroom/homebrew-cask) 安装 MarkText。要使用 Homebrew-Cask，您只需要安装 [Homebrew](https://brew.sh/)。
...
您可以从 [release 页面](https://github.com/5faith/marktext-enhance/releases/latest)下载适用于 Linux、macOS 和 Windows 的所有二进制文件。如果您的系统无法正常使用某个版本，请创建一个 [issue](https://github.com/5faith/marktext-enhance/issues)。
...
感谢所有为 MarkText 做出贡献的人[[贡献者](https://github.com/5faith/marktext-enhance/graphs/contributors)]
